...
const BeautyServicesPage: React.FC<BeautyServicesPageProps> = ({ navigate, businesses }) => {
  const [searchQuery, setSearchQuery] = useState('');
  const [selectedServiceType, setSelectedServiceType] = useState('All Beauty');
  const [selectedLocation, setSelectedLocation] = useState('All Areas');
  const [showMobileFilter, setShowMobileFilter] = useState(false);

  // Beauty-focused service types for filtering
  const serviceTypes = [
    'All Beauty',
    'Spas & Massage',
    'Hair Salons',
  ...
  // Get all beauty & wellness businesses
  const allServices = useMemo(() =>
    businesses.filter(b => b.category === Category.BeautyWellnessPersonalCare),
    [businesses]
  );
  ...
  const filteredServices = useMemo(() => {
    return allServices.filter(service => {
      ...
      const matchesServiceType =
        selectedServiceType === 'All Beauty' ||
        ...
        <div className="container mx-auto px-4 md:px-6 py-12 md:py-16">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-300 font-light leading-relaxed mb-4">
              Discover Mpumalanga's trusted salons, spas, clinics and wellness studios.
            </p>
            ...
            <div className="relative max-w-xl mx-auto mb-8">
              ...
              <input
                type="text"
                placeholder="Search salons, spas, clinics and treatments…"
                value={searchQuery}
          ...
          <div className="lg:col-span-1">
            ...
            <div className={`${showMobileFilter ? 'block' : 'hidden'} lg:block bg-black rounded-2xl p-6 shadow-sm sticky top-24 h-fit border border-gray-800` }>
              ...
              <button
                onClick={() => {
                  setSearchQuery('');
                  setSelectedServiceType('All Beauty');
          ...
          <div className="lg:col-span-3">
            <div>
              <div className="mb-8 pb-8 border-b border-gray-800 relative">
                <p className="text-xs text-[#D4AF37] font-light tracking-widest uppercase mb-2">BEAUTY &amp; WELLNESS</p>
                <p className="text-sm text-gray-400 font-light">Showing {filteredServices.length} providers</p>
              </div>

              {filteredServices.length > 0 ? (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {filteredServices.slice(0, 1).map((provider) => (
                    <div
                      key={provider.id}
                      ...
                      onClick={() => navigate('service-detail', Category.BeautyWellnessPersonalCare, provider.id)}
                    >
                      ...
                      <div className="p-4 space-y-2">
                        ...
                        <p className="text-xs text-[#D4AF37] font-light uppercase">{provider.subcategory || provider.tags?.[0] || 'Beauty'}</p>
                        ...
                        <button
                          onClick={(e) => { e.stopPropagation(); navigate('service-detail', Category.BeautyWellnessPersonalCare, provider.id); }}
                ...
                <div className="text-center py-16">
                  ...
                  <button
                    onClick={() => { setSearchQuery(''); setSelectedServiceType('All Beauty'); setSelectedLocation('All Areas'); }}
            ...
            <div className="mt-20 pt-20 border-t border-gray-100">
              <div className="max-w-2xl">
                ...
                <h2 className="text-3xl font-medium text-white mb-4">List Your Beauty Business</h2>
                <p className="text-sm text-gray-300 font-light leading-relaxed mb-8 max-w-xl">Join Mpumalanga's premium beauty ecosystem and connect with customers searching for salons, spas and clinics.</p>
