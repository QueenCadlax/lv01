...
const RealEstatePropertyDetailView: React.FC<PropertyDetailViewProps> = ({ 
  propertyId, 
  navigate, 
  businesses, 
  favorites,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            {/* Property Details */}
            <div className="mt-8 bg-[#D4AF37]/5 border border-[#D4AF37]/30 rounded-xl p-8">
              <h2 className="text-2xl font-serif text-[#D4AF37] mb-6">About This Property</h2>
            ...
            {/* Features / Amenities */}
            <div className="mt-8 bg-[#D4AF37]/5 border border-[#D4AF37]/30 rounded-xl p-8">
              <h2 className="text-2xl font-serif text-[#D4AF37] mb-6">What's Offered</h2>
            ...
            {similarProperties.length > 0 && (
              <div className="mt-12">
                <h2 className="text-2xl font-serif text-[#D4AF37] mb-6">Similar Properties in {property.location}</h2>
                  ...
                  {similarProperties.map(prop => (
                    ...
                    >
                      ...
                      <div style={{ height: '65%', position: 'relative', overflow: 'hidden' }}>
                        ...
                        <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: '1px', background: 'linear-gradient(90deg, transparent, rgba(212,175,55,0.5), transparent)', pointerEvents: 'none' }} />
                      </div>
                      ...
                      <div style={{ padding: '16px 14px 14px 14px', color: '#FFFFFF', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', height: '35%', fontSize: 14 }}>
                        ...
                        <div style={{ minHeight: 0 }}>
                          ...
                          <div style={{ fontSize: 17, fontWeight: 700, color: '#D4AF37', fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", letterSpacing: '0.2px', marginBottom: 8 }}>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 bg-[#D4AF37]/5 border border-[#D4AF37]/30 rounded-2xl p-8 space-y-6">
              {/* Price Display */}
              <div>
                <div className="text-xs text-gray-400 uppercase tracking-widest mb-2">List Price</div>
                <div className="text-4xl font-bold text-[#D4AF37]">R 8,500,000</div>
              ...
              {property.rating > 0 && (
                <div className="pb-6 border-b border-[#D4AF37]/20">
                  <div className="flex items-center gap-2">
                    <span className="text-lg font-bold text-[#D4AF37]">{property.rating.toFixed(1)}</span>
              ...
              <div className="bg-gradient-to-br from-[#D4AF37]/10 to-[#D4AF37]/5 border border-[#D4AF37]/30 rounded-xl p-4">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-full bg-[#D4AF37]/20 border border-[#D4AF37]/30 flex items-center justify-center flex-shrink-0">
                    <span className="text-lg font-bold text-[#D4AF37]">JW</span>
                  </div>
                  <div>
              ...
              {/* Primary CTA */}
              <button className="w-full bg-gradient-to-r from-[#D4AF37] to-[#D4AF37] text-black font-bold py-3 rounded-xl hover:shadow-lg hover:shadow-[#D4AF37]/50 transition-all flex items-center justify-center gap-2">
                <Calendar size={18} />
                Book Viewing
              </button>
              ...
              <div className="space-y-2">
                <button
                  ...
                  className="w-full text-white border border-[#D4AF37]/30 py-2 rounded-lg hover:bg-white/5 transition-all flex items-center justify-center gap-2 text-sm"
                >
              ...
              {/* Share Button */}
              <button className="w-full text-white border border-[#D4AF37]/30 py-2 rounded-lg hover:bg-white/5 transition-all flex items-center justify-center gap-2 text-sm">
        ...
        {/* Map Section */}
        <div className="mt-16 bg-[#D4AF37]/5 border border-[#D4AF37]/30 rounded-2xl overflow-hidden">
          ...
          <div className="p-6">
            <h2 className="text-xl font-serif text-[#D4AF37] mb-2">Location</h2>
...
export default RealEstatePropertyDetailView;
